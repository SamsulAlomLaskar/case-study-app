...
function Question() {
  ...
  const [diffLevelError, setdiffLevelError] = useState("");
  ...
  return (
    <div className="m-5">
        ...
        <Row className="g-2 ">
          ...
          <Col md={3}>
            <FloatingLabel controlId="floatingInputGrid" label="Client Name">
              ...
              {clientNameCharError && (
                <Form.Text className="errmsg">
                  Candidate mame should contain only characters
                </Form.Text>
              )}
            </FloatingLabel>
          </Col>
              ...
              <>
                <Col md={9}>
                  <FloatingLabel controlId="floatingInputGrid" label="Question">
                    ...
                    />
                    <Form.Text className="errmsg">
                      {questions[index].question ? "" : questionError}
                    </Form.Text>
                  </FloatingLabel>
                </Col>
                <Col md={3}>
                  ...
                  >
                    ...
                    <Form.Text className="errmsg">
                      {questions[index].question ? "" : diffLevelError}
                    </Form.Text>
                  </FloatingLabel>
                </Col>
                <Col lg={9}>
      ...
      {showSubmitModal && (
        <SubmitModal validateForm={validateForm} showModal={showModal} />
      )}
      {isshowDelete && (
        <DeleteConfirmation
